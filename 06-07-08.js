...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      var nuevoarray = this.amigos.map(function (elemento){
    ...
    getHobbies() {
      ...
      // Tu código aca:
      var jobis = this.hobbies.map(function (elemento){
        return elemento;
      })
      return jobis;
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
       var promedio = this.amigos.map(function (elemento){
